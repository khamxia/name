...
class StoreSaleDetail extends StatefulWidget {
  final List<BImage> images;
  final String pname;
  final int amount;
  final int price;
  final String detail;
  ...
  @override
  State<StoreSaleDetail> createState() => _StoreSaleDetailState();
}

class _StoreSaleDetailState extends State<StoreSaleDetail> {
  int currentPos = 0;
  @override
